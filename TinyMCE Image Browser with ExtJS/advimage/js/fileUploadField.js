 ...
 */
/**
 * @class FileUploadWindow.FileUploadField
...
Ext.ux.FileUploadField = Ext.extend(Ext.form.TextField, {
			...
			initComponent : function() {
				Ext.ux.FileUploadField.superclass.initComponent
						.call(this);
			...
			onRender : function(ct, position) {
				Ext.ux.FileUploadField.superclass.onRender.call(this,
						ct, position);
			...
			onResize : function(w, h) {
				Ext.ux.FileUploadField.superclass.onResize.call(this,
						w, h);
			...
			// private
			onDestroy : function() {
				Ext.ux.FileUploadField.superclass.onDestroy
						.call(this);
				Ext.destroy(this.fileInput, this.button, this.wrap);
			},

			onDisable : function() {
				Ext.ux.FileUploadField.superclass.onDisable
						.call(this);
				this.doDisable(true);
			},
